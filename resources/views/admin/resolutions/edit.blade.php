...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1>  Resolution Code  Edit</h1>
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><i class="fa fa-angle-right"></i>    Resolution Code Edit</li>
            </ol>
        </div>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-lg-12">
                <a href="{{ URL::route('Resolutions') }}"><span class="btn btn-sm btn-info m-b-2"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
...
<div class="row">
    ...
    <div class="form-group has-feedback">
                            <label>Code</label>
                                <input type="text" name="res_code" @if(isset($parts)) value="{{ $parts->resolution_code }}" @endif  class="form-control "  >
                            </div>
 ...
 <div class="form-group has-feedback">
                            <label>Description
                                ...
                                <input type="text" name="res_desc" @if(isset($parts)) value="{{ $parts->resolution_description }}" @endif  class="form-control " >
                            </div>
        ...
        <input type="hidden" name="type" value="editResolution">
                                 
                                        <input type="hidden" name="resolution_id" value="{{$parts->resolution_id}}">
