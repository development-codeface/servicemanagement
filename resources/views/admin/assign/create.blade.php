      ...
      <div class="row">
        ...
        <fieldset class="form-group">
              ...
              <option>Select WareHouse</option>
                 ...
                 <option value={{$ware->warehouse_id}}>{{$ware->name}}</option>
                 @endforeach
            </select>           
         </fieldset>
            </div>
		...
		<div class="col-md-12 cenbut">
             <input type="hidden" name="type" value="JobAssign">
...
<div class="modal fade modaltop animated growIn slow go " id="myModal" role="dialog">
 <div class="modal-dialog">
   ...
   <div class="modal-content modaltop">
     ...
     <h4 class="modal-title"> Job Assigned To Selected WareHouse....</h4>
        ...
        $.ajax({
            ...
            success: function(data){
                setInterval(function(){
                    ...
                    $('#myModal').modal('show');
                  window.location.href="{{URL::route('AssignedJobs')}}";
                }, 1500);
