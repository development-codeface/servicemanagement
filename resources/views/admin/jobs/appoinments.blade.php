                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <td><a class="btnsedit"  data-tooltip="View" href="{{URL::route('ViewJob',$adm->job_id)}}" ><i class="fa fa-eye pad"></i></a>
</td>
                                
                                <td>{{$adm->repaire_order_no}}</td>
                                <td>{{$adm->job_location}}</td>
                                <td>{{date('d-m-Y', strtotime($adm->appointment_time))}}</td>
                                @if($adm->appointment_status != 'false')
                                <td>Created</td>
                                @else
                                <td>Cancelled</td>
                                @endif
