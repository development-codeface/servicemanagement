...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1>  Symptom Code  Edit</h1>
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><i class="fa fa-angle-right"></i>    Symptom Code Edit</li>
            </ol>
        </div>
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-lg-12">
                <a href="{{ URL::route('Symptom') }}"><span class="btn btn-sm btn-info m-b-2"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
...
<div class="row">
    ...
    <div class="form-group has-feedback">
                            <label>Code</label>
                                <input type="text" name="sym_code" @if(isset($parts)) value="{{ $parts->symptom_code }}" @endif  class="form-control "  >
                            </div>
 ...
 <div class="form-group has-feedback">
                            <label>Description
                                ...
                                <input type="text" name="sym_desc" @if(isset($parts)) value="{{ $parts->symptom_description }}" @endif  class="form-control " >
                            </div>
        ...
        <input type="hidden" name="type" value="editSymptom">
                                 
                                        <input type="hidden" name="symptom_id" value="{{$parts->symptom_id}}">
