...
@section('content')
   ...
   {{-- <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1>UnAssingned Jobs</h1>
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><i class="fa fa-angle-right"></i>UnAssingned Jobs</li>
            </ol>
        </div>
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="     width: 1629px;">
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btnview js-mytooltip"  href="{{URL::route('NewAssignTechnician',$job->job_id)}}">Assign</a>
="fa fa-trash pad"></i></a>
                                </td>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="card m-t-3">
                <div class="card-body">
                <a href="{{ URL::route('AspJobs') }}"><span class="btn btn-sm btn-info"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="        width: 1682px;">
                            ...
                            <tr>
                                ...
                                <td>
                                <a class="btnview js-mytooltip"  href="{{URL::route('NewAssignTechnician',$job->job_id)}}"> <span class="label label-info"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i> Assign</span></a>
