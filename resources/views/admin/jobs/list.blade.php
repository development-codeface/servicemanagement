...
<div class="row">
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#uploadcsv">
		<i class="fa fa-upload"></i> Upload CSV</button>
		  </div>
								...
								<div class="row">
								  <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input class="form-control" name="change_code" id="time" value=""  type="text">
									  ...
									  <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input class="form-control" name="seriel_number" id="time" value=""  type="text">
									  ...
									  <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input class="form-control" name="serv_item" id="time" value=""  type="text" readonly>
...
<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> No Results  Found 
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-bordered table-striped" style="">
                            ...
                            <td>
                                ...
                                @else <td>
                                <select class="changestatus" id="getele"  onchange="onChangestatus(this)" data-id="{{$job->job_id}}" data-sym="{{$job->symptom_id}}" data-fal="{{$job->faulty_id}}"data-res="{{$job->resolution_id}}" data-symptom="{{$job->symptom_description}}" data-resol="{{$job->resolution_description}}" data-faulty="{{$job->faulty_description}}" data-repair="{{$job->repaire_order_no}}"
                                ...
                                data-jobloc="{{$job->job_location}}"  data-jobremark="{{$job->job_remark}}"  data-fround="{{$job->turn_fround_time}}" data-jobdesc="{{$job->description}}"  data-asploc="{{$job->asp_location}}" data-grnid="{{$job->grn_id}}" data-rmaid="{{$job->gma_id}}"
                                ...
                                @foreach($status as $tech)        
                                 ...
                                 <td> <select class="sel_ware" id="getid" onchange="selectWarehouse(this)" data-id="{{$job->job_id}}">
                               ...
                               <td> 
                               <?php  $query = App\Models\User::leftjoin('asp_tech','asp_tech.asp_technician','=','users.id')
               ...
               ->get();  ?>
                               <select class="assigntech" id="getid" onchange="assignTn(this)" style="width: 137px;" id="jo-tech_{{$job->job_id}}" data-id="{{$job->job_id}}">
            ...
            <form id="CustomerNotInForm">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
                    ...
                    <div class="m-b-2 modalFooter" id="modalFooter">
...
//JOB
       ...
       window.location = "{{ URL::route("Pendingpart") }}/"+job_id; 
        ...
        if(status == 103){
		 ...
		 if(status == 91){
			...
			function selectWarehouse(selcode){
 ...
 setTimeout(function(){
        ...
        return false;
			...
			function assignTn(seltech){
				var us_id = seltech.value;
...
$('#value_Date_Listed_1').wickedpicker({twentyFour: false});
