    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i> GRN Request</li>
            </ol>
        </div>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                <a href="{{ URL::route('GmaRequests') }}"><span class="btn btn-sm btn-info m-b-1"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
                    <div class="card ">
...
<hr>
                                ...
                                <div class="col-md-12">
                                    <input type="hidden" name="type" value="editgrn">
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            setInterval(function(){
                                ...
                                $('#myModal').modal('show');
                       window.location.href="{{URL::route('GmaRequests')}}";
                            }, 1500);
