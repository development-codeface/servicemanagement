...
@section('content')
  ...
  <div class="col-md-12">
          <a href="{{ URL::route('TechJobs') }}"><span class="btn btn-sm btn-info m-b-1"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
				  ...
				  <div class="panel panel-default">
                    ...
                    <div class="edc">
                        <div class="row tx_hd">
                            <div class="col-lg-4">
                                <h2> Purchase Date</h2>
                                <p> {{date('d-m-Y', strtotime($job->gma_purchase))}} </p>
 ...
 <input type="checkbox" id="dot_screen" name="dot_screen"
               ...
               value="1"   @if($job->abnormal_pic == 1) checked=checked @endif/>     
							...
							<div class="col-lg-4">
                                <h2>
                                   Delivery Date</h2>
                                <p > {{date('d-m-Y', strtotime($job->prod_del))}}</p>
