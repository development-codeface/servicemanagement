                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ URL::route('AdminProfile') }}" class="btn btn-default btn-flat">Profile</a>
                                </div>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                        ...
                        <li @if(Request::segment(1)== 'dashboard')  class="active"  @endif><a href="{{ URL::route('AdminDashboard') }}"><i class="fa fa-circle-o"></i> Dashboard </a></li>
                        <li @if(Request::segment(1)== 'csvfiles')  class="active"  @endif ><a href="{{ URL::route('Csv') }}"><i class="fa fa-circle-o"></i> Csv Files </a></li>
                        <li @if(Request::segment(1)== 'technicians')  class="active"  @endif ><a href="{{ URL::route('Technicians') }}"><i class="fa fa-circle-o"></i> Technicians </a></li>
...
<script type="text/javascript" src="{{ url('assets/admin/js/bootstrap-datepicker.js') }}"></script>
{{--
