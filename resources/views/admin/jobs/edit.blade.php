...
@else
        ...
        <fieldset class="form-group">
              <label>Parts</label>
              <select class="form-control partqty" onchange="onChangeNewquantity(this)" name="parts[]" id="partno1">
...
<div class="row">
           ...
           <fieldset class="form-group amont hidden">
               ...
               <fieldset class="form-group amt hidden">
                 <label>Amount</label>
               ...
               <fieldset class="form-group ex_number hidden">
                ...
                <fieldset class="form-group grn_rem hidden">
                 <label>Remarks</label>
   
                 <textarea class="form-control" type="text" id="rma_remarks" name="grn_remarks"
                />  </textarea> 
               </fieldset>
               </div>
               <div class="col-lg-4 ">
               @if($job->is_cn_ex == 2) 
               <fieldset class="form-group ex_number">
                 <label>Exchange Number</label>
               ...
               @endif
               @if($job->is_cn_ex == 1)
               <fieldset class="form-group amont ">
                 <label>Credit Note</label>
...
@endif
        ...
        <fieldset class="form-group">
              ...
              <div class="col-lg-4">
                                      <fieldset class="form-group">
                                            <label>Approve/Reject</label><br>
                                            @if($job->claim_approv==1)<input type="radio" name="reject" value="1" checked> Approve &nbsp;
@else                                           <input type="radio" name="reject" value="1" > Approve &nbsp;
                                            @endif
                                            @if($job->claim_approv==2) <input type="radio" name="reject" value="2" checked>  Reject<br>  
...
<script src="{{ asset('assets/admin/js/wickedpicker.min.js')}}"></script>
    ...
    <script>
	 var myselect;
        function onChangeNewquantity(selectObj){
			alert();
                var status = selectObj.value;
                 myselect = selectObj;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            if (data.aval_qty < 0) {
                               //$("#avl_part_qty").val(0);
                                $(myselect).parent().parent().parent().find('.avlqty').val(0);
                            } else {
                                //$("#avl_part_qty").val(data.aval_qty);
                                $(myselect).parent().parent().parent().find('.avlqty').val(data.aval_qty);
                            }
...
$(Rows).append('<div class="container remdiv">'+'<div class="row">'+' <div class="col-lg-4">'+
                        '<fieldset class="form-group">'+
                        ' <label>Parts</label>'+
                        ' <select class="form-control" onchange="onChangeNewquantity(this)" name="parts[]">'+
