         ...
         @if($job->isapprove !=0)
                                    <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="radio" name="reject" value="1" @if($job->isapprove==1)checked @endif disabled> Approve &nbsp; 
											
                                             <input type="radio" name="reject" value="2" @if($job->isapprove==2)checked @endif disabled>  Reject<br>  
                                    ...
                                    <div class="col-lg-4 appr hidden">
                                        <fieldset class="form-group">
                                            ...
                                            <input class="form-control" id="datepicker1" value="{{date('d-m-Y', strtotime($job->part_del))}}" name="del_date"  type="text" required>
                                            @else
                                            <input class="form-control" id="datepicker1" value="" name="del_date"  type="text"required readonly >
                                          @endif
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-4 rej hidden">
                                        <fieldset class="form-group">
                                            <label> Remarks</label>
                                            <textarea class="form-control disable" name="note" readonly ></textarea>                                      
                                             </fieldset>
                                    </div>
									
									
                            @if($job->part_del)<div class="col-lg-4 appr">
                                        <fieldset class="form-group">
                                            <label>	Delivery Date</label>
                                            @if($job->part_del)
                                            <input class="form-control" id="datepicker1" value="{{date('d-m-Y', strtotime($job->part_del))}}" name="del_date"  type="text" required readonly>
                                            @else
                                            <input class="form-control" id="datepicker1" value="" name="del_date"  type="text"required readonly>
                                          @endif
                                        </fieldset>
                                    ...
                                    <div class="col-lg-4 rej " >
                                        <fieldset class="form-group">
                                            <label> Remarks</label>
                                            <textarea disabled class="form-control disable" name="note"  >{{$job->part_remark}}</textarea>                                      
                                             </fieldset>
                                    </div>
									@endif
...
@if($job->is_cn_ex !=NULL) 
   <div class="col-lg-4">
			   ...
			   @endif
			    @if($job->gma_credit)<div class="col-lg-4">
           <fieldset class="form-group">
                 <label>Credit Note</label>
           ...
           <fieldset class="form-group">
                 ...
                 <input class="form-control"  name="dealer_name" value="{{$job->gma_ex}}" id="reason"  type="text" readonly >
