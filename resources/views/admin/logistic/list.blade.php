                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="">
                            ...
                            <tr class="strlength">
                            <td>
                                    <a class="btnsedit " href="{{URL::route('ViewPartLog',$job->part_order_id)}}" title="Edit"><i class="fa fa-eye pad"></i></a>
                                    @if($job->status != 101)
                         ...
                         @endif
                                ...
                                <td>{{$job->name}}</td>
                                @if($job->status == 46)
                                <td> <a class="btnsedit js-mytooltip"  data-tooltip="Generate Pdf" href="{{URL::route('GenerateDeliveryParts',$job->job_id)}}" ><i class="fa fa-file-pdf-o"></i></a></td>
                                @else
                                <td>Pending</td>
                                @endif                            
