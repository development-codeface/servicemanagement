        ...
        <div class="row">
                            ...
                            @if($job->delivery_date)<div class="col-lg-4 appr">
                                    ...
                                    <div class="col-lg-4 rej " >
                                        <fieldset class="form-group">
                                            <label> Remarks</label>
                                            <textarea class="form-control disable" name="note" >{{$job->part_remark}}</textarea>                                      
                                             </fieldset>
                                    </div>
									@endif
   ...
   <div class="row">
           ...
           <fieldset class="form-group amont hidden">
			   ...
			   <fieldset class="form-group amt hidden">
			    ...
			    <fieldset class="form-group sel_pr hidden">
                 <label>Last Selling Price RM</label>
   
                 <input class="form-control" type="text" id="amount" name="sell_price"
                 />   
               </fieldset>
               <fieldset class="form-group ex_number hidden">
			    ...
			    <fieldset class="form-group grn_rem hidden">
                 ...
                 <textarea class="form-control" type="text" id="grn_remarks" name="grn_remarks"
                />  </textarea> 
               </fieldset>
               </div>
               <div class="col-lg-5 ">
			   ...
			   <fieldset class="form-group amont ">
			    ...
			    <fieldset class="form-group amont ">
                 ...
                 <input class="form-control" type="text" value="{{$job->grn_amount}}" id="credit_not" name="credit_not"
                 />   
               </fieldset>
			   </div>
			   <div class="col-lg-4">
			    <fieldset class="form-group amont ">
                 ...
                 <input class="form-control" type="text" value="{{$job->sell_price}}" id="credit_not" name="credit_not"
                 />   
               </fieldset>
			   </div>
			   </div>
...
@section('footer')
<script src="{{ asset('assets/admin/js/wickedpicker.js')}}"></script>
</script>
...
$(Rows).append('<div class="container ">'+'<div class="row remdiv">'+' <div class="col-lg-6">'+
                        '<fieldset class="form-group">'+
                        ' <label>Parts</label>'+
