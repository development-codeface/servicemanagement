            ...
            <div class="card m-t-3">
                <div class="card-body">
                     ...
                     <table id="example1" class="table table-bordered table-striped">
                            ...
                            <td>
                                <a class="btnsedit"  data-tooltip="View" href="{{URL::route('ViewAspJob',$job->job_id)}}" ><i class="fa fa-eye pad"></i></a>

                                    <a class="btnsedit"  data-tooltip="Edit" href="{{URL::route('EditAspJob',$job->job_id)}}" ><i class=" edi pad fa fa-edit"></i></a>
                                    ...
                                    <a href="{{URL::route('AspAppointment',$job->job_id)}}" class="js-mytooltip  btnsecal confirm "
                                       data-tooltip="Appointment"><i class="fa fa-phone"></i></a>
                                       @endif  -->
                                       <!-- @if($job->part_order_id != NULL)

                                      
                                    <a class="btnact js-mytooltip" data-tooltip="Parts Order Request" href="{{URL::route('AspWaitingParts',$job->job_id)}}" ><i class="fa fa-first-order"></i></a>
                                    @endif
                                    @if($job->claim_id != NULL)
                                    <a class="btnact js-mytooltip" data-tooltip=" Request For claim" href="{{URL::route('AspNewClaim',$job->job_id)}}" ><i class="fa fa-file"></i></a>
                                    @endif -->
                                    @endif
                                ...
                                @else
                                <td>
                                <select class="changestatus" data-tech="{{$job->id}}" data-id="{{$job->job_id}}" data-sym="{{$job->symptom_id}}" data-fal="{{$job->faulty_id}}" data-res="{{$job->resolution_id}}" data-symptom="{{$job->symptom_description}}" data-resol="{{$job->resolution_description}}" data-faulty="{{$job->faulty_description}}" data-repair="{{$job->repaire_order_no}}"
                                data-fname="{{$job->firstname}}" data-lname="{{$job->lastname}}" data-addrs="{{$job->cu_address}}" data-phn="{{$job->phone_no}}" data-bus="{{$job->bussiness_number}}"   data-partrem="{{$job->part_remark}}" 
                                ...
                                @endif
                                <td>
                                <select class="assigntech" data-id="{{$job->job_id}}">
          ...
          <button type="submit" class="btn btn-lg btn-success"><i class=" fa fa-hdd-o"></i> Create</button>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                        <form id="partsform" name="partsform">
            <div class="row">
...
<!-- 		
            ...
            <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-control" name="faulty" id="faultypp" >
                                    ...
                                    <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-control" name="symptom" id="symptompp">
                                    ...
                                    <div class="col-lg-4">
                                        <fieldset class="form-group">
                                            ...
                                            <select class="form-control" name="resolution" id="resolpp">
        ...
        <fieldset class="form-group">
              <label>Parts</label>
              <select class="form-control phone-group" name="parts[]" id="partno1" >
           ...
           <div class="col-lg-4">
              <fieldset class="form-group">
                ...
                @else
                <input class="form-control phone-group"  name="qnty[]" value="1"   id="qty1"  type="number" readonly >
@endif
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <fieldset class="form-group">
              <label>Job Id </label>
              <input class="form-control"  id="job22id" name="job_id_ap"  type="text" readonly>
            </fieldset>
          </div>
        ...
        <fieldset class="form-group">
              ...
              <input class="form-control" name="datepicker" id="datepicker_appt"  type="text" recquired>
		...
		<div class="col-md-12 cenbut">
    <input type="hidden" name="type" value="newAppointmentAsp">
		 ...
		 <hr>
           ...
           <div class="col-lg-4">
              <fieldset class="form-group">
                ...
                @else
                <input class="form-control phone-group"  name="qnty[]"   id="placeholderInput"  type="number" >
@endif
