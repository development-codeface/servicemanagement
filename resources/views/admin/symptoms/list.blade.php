...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1>Symptom Code Setup</h1>
            <ol class="breadcrumb">
                <li><a href="#">Dashboard</a></li>
                <li><i class="fa fa-angle-right"></i> Symptom Code Setup</li>
            </ol>
        </div>
    ...
    <div class="modal-dialog  ">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Create Symptom Code</h4>
...
<div class="col-md-12">
                           ...
                           <label>Code</label>
                                <input type="text" name="sym_code" class="form-control "  >
                            </div> 
                            </div>
                            </div>
...
<div class="form-group has-feedback">
                            <label>Description</label>
                                <input type="text" name="sym_desc"   class="form-control "  >
                            </div>
    </div>
                            ...
                            <span id="error"></span>
                              ...
                              <input type="hidden" name="type" value="newSymptom">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="">
                            ...
                            <td>
                            <a class="btnsedit " href="{{URL::route('ViewSymptom',$job->symptom_id)}}" title="View"><i class="fa fa-eye pad"></i></a>


<a class="btnsedit " href="{{URL::route('EditSymptom',$job->symptom_id)}}" title="Edit"><i class=" edi pad fa fa-edit"></i></a>
<a class="btnsecal  deleteButton" data-tooltip="Delete" data-id="{{$job->symptom_id}}"  data-toggle="modal"  data-target="#deleteModal" title="Delete Details"><i class="fa fa-trash pad"></i></a>
                                </td>
            ...
            <form id="deleteModalForm">
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <input type="hidden" name="type"   value="delete_symptom" />
                ...
                <div class="modal-header">
              <h5 class="modal-title">Delete Symptom Code</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
                    ...
                    <div class="modal-body">
                        <p>Are you sure Delete Symptom Code?</p>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            setInterval(function(){
                                ...
                                $('#myModal').modal('show');
                          window.location.href="{{URL::route('Symptom')}}";
                            }, 1500);
