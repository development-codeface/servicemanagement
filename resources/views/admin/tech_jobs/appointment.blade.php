            ...
            <div class="right-page-header">
                            <div class="d-flex">
                                <div class="align-self-center">
                                    <h5 class="text-white m-b-0">Appointment Date &nbsp;&nbsp;<span class="label label-warning">{{date('F d, Y', strtotime($apps->appointment_time))}} </span></h5>
                                </div>
...
<div class="modal fade modaltop animated growIn slow go " id="myModal" role="dialog">
 <div class="modal-dialog">
   ...
   <div class="modal-content modaltop">
     ...
     <h4 class="modal-title"> Appointment Updated</h4> 
