...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            <h1>Asp Admin Dashboard</h1>
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li><i class="fa fa-angle-right"></i>Asp Admin Dashboard</li>
            </ol>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="tile-progress tile-pink">
                        ...
                        <a href="{{URL::route('AspJobs')}}">View More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <div class="tile-progress tile-cyan">
                        ...
                        <div class="tile-footer">
                        <a href="{{URL::route('AspJobsCompleted')}}">View More</a>
                        </div>
                    </div>
                </div>
