                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="">
                            ...
                            @if($job->status != 103)
                                    ...
                                    <button  type="button" data-id="{{$job->job_id}}" data-toggle="modal" data-target="#largeModal1" class="btn btn-success deliver">Deliver</button>
                                    @else
