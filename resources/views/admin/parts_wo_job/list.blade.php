    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="card m-t-3">
                <div class="card-body">
                <a href="{{ URL::route('CreatePartWithOutJob') }}"><span class="btn btn-sm btn-success"><i class="fa fa-arrow-circle-up" aria-hidden="true"></i> Create New Request 
</span></a>
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped"style="">
                            ...
                            <td>
                                    <a class="btnview js-mytooltip" data-tooltip="View" href="{{URL::route('ViewPartsWoJob',$job->part_order_id)}}" title="view"><i class="fa fa-eye pad"></i></a>
