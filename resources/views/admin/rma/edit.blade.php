    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-angle-right"></i> Rma Request</li>
            </ol>
        </div>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                <a href="{{ URL::route('RmaRequests') }}"><span class="btn btn-sm btn-info m-b-1"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back
</span></a>
                    <div class="card ">
...
<hr>
                               ...
                               <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4 ">
                                        <fieldset class="form-group appr hidden">
                                            <label>	Delivery Date</label>
                                            
                                            @if($job->delivery_date)
                                            <input class="form-control"  value="{{date('d-m-Y', strtotime($job->delivery_date))}}" id="datepicker1" name="del_date"  type="text" required>
                                            @else
                                            <input class="form-control"   id="datepicker1" name="del_date"  type="text" required>
                                           @endif                                        
                                        </fieldset>
                                    ...
                                    <!-- <div class="col-lg-4 rej select-pane" id="serie-0">
                                       
                                    </div> -->
                               </div>
                               </div>
                                <div class="col-md-12">
                                    <input type="hidden" name="type" value="editrma">
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            setInterval(function(){
                                ...
                                $('#myModal').modal('show');
                    window.location.href="{{URL::route('RmaRequests')}}";
                            }, 1500);
